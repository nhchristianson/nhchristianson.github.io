...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-visited-uc-berkeley-to-give-an-emerge-seminar-a-big-thanks-to-yi-ju-and-scott-moura-for-inviting-and-hosting-me",
          title: 'Visited UC Berkeley to give an eMERGE Seminar. A big thanks to Yi...',
          description: "",
          section: "News",},{id: "news-our-paper-end-to-end-conformal-calibration-for-optimization-under-uncertainty-was-accepted-at-transactions-on-machine-learning-research",
          title: 'Our paper End-to-End Conformal Calibration for Optimization Under Uncertainty was accepted at Transactions...',
          description: "",
          section: "News",},{id: "news-it-was-great-attending-informs-in-atlanta-and-and-catching-up-with-so-many-collaborators-and-friends-i-gave-a-talk-on-end-to-end-learning-for-contingency-screening-in-the-session-human-centric-energy-markets",
          title: 'It was great attending INFORMS in Atlanta and and catching up with so...',
          description: "",
          section: "News",},{id: "news-i-gave-a-talk-on-risk-sensitive-online-algorithms-in-the-cs-theory-seminar-at-umass-amherst-thanks-to-my-wonderful-collaborators-adam-lechowicz-and-mohammad-hajiesmaili-for-hosting-me",
          title: 'I gave a talk on risk-sensitive online algorithms in the CS Theory Seminar...',
          description: "",
          section: "News",},{id: "news-i-am-at-neurips-in-san-diego-this-week-our-paper-on-end-to-end-conformal-risk-control-will-be-presented-in-the-poster-session-on-wednesday",
          title: 'I am at NeurIPS in San Diego this week! Our paper on End-to-End...',
          description: "",
          section: "News",},{id: "news-two-papers-accepted-to-acm-sigmetrics-2026-one-on-online-smoothed-demand-management-and-another-on-prediction-specific-design-of-learning-augmented-algorithms-many-thanks-to-my-wonderful-collaborators",
          title: 'Two papers accepted to ACM SIGMETRICS 2026: one on online smoothed demand management...',
          description: "",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "talks-rain-seminar-at-stanford",
          title: 'RAIN Seminar at Stanford',
          description: "",
          section: "Talks",},];
