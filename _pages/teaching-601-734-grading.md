---
layout: course
permalink: /teaching/601-734/grading/
title: Grading and course policies
description: Grading for EN.601.734
course_section: grading
nav: false
---
...
See below for policies on attendance and participation, and see the [Paper presentations]({{ '/teaching/601-734/paper-presentations/' | relative_url }}) and [Project]({{ '/teaching/601-734/project/' | relative_url }}) pages for more detailed grading breakdowns for those assignments.
...
The strength of the university depends on academic and personal integrity. In this course, you must be honest and truthful, abiding by the [Computer Science Academic Integrity Policy](https://www.cs.jhu.edu/academic-programs/academic-integrity-code/). 
...
For further information about this process, please refer to the [SDS Website](https://sds.jhu.edu/).
